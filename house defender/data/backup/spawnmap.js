...
map[0] = function() {
	return [
		new tile('blue',50,100,100,50,true,true,true,true),
		new tile('red',85,70,50,10,true,true,true,true),
		new tile('lime',-150,80,140,2,true,true,true,true),
		new tile('lime',-150,40,140,1,true,false,false,false)
	];
}