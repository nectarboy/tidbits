...
guns[1] = new gun('Wall Shotgun','#eec4ff',3,0,0,0,10,18,5,17,2,0.4,3);
guns[2] = new gun('Water Squirter','#0080ff',4,-1,0,0.1,4,2,0.5,10,2,0.1,3);
...
guns[9] = new gun('Flamethrower','#e67b1e',5,1,0,-0.3,4,3,2.5,4,4,0,6);